...
const MyPost = () => {
    ...
    useEffect(() => {
        if (isError) {
            toast({
                ...
                description: "please try again laterss",
                variant: "destructive"
            })
            setOpen(true)
        }
    ...
    return (
        <div className="h-screen">
            <div className="sm:w-1/2 w-3/4 p-4 mx-auto mt-20 bg-red-500 rounded shadow">
                <div className="flex justify-center mt-20">
                    <div className="">
                        <Avatar className="w-28 h-28">
                            <AvatarImage src={data?.profile} alt="@shadcn" />
                            <AvatarFallback>PPsdasdas</AvatarFallback>
                        </Avatar>
                        <h3 className='mt-6 text-2xl font-semibold'>ame</h3>
                        ...
                        <Dialog open={open} onOpenChange={setOpen}>
                            ...
                            <DialogContent className="sm:max-w-xl">
                                <DialogHeader>
                                    ...
                                    <DialogDescription>
                                        Update your profile and find you other sdfsf
                                    </DialogDescription>
                                </DialogHeader>
